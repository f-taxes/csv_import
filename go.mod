module github.com/f-taxes/csv_import

go 1.22.0

require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.33.0-20240221180331-f05a6f4403ce.1
	gitea.codeblob.work/pk/gut/conf v0.0.0-20240305181423-ab1728eefc68
	gitea.codeblob.work/pk/gut/irisutils v0.0.0-20240305230032-00f9919c285c
